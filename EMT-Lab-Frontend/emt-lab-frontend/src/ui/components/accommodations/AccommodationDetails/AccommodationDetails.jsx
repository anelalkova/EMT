...
const AccommodationDetails = () => {
    const {id} = useParams();
    const {accommodation, category, host} = useAccommodationDetails(id);
    const navigate = useNavigate();

    if (!accommodation || !category || !host) {
        return (
                        ...
                        <Box sx={{mb: 3}}>
                            ...
                            <Stack direction="row" spacing={1} alignItems="center" sx={{mb: 2}}>
                                <Typography variant="body2" color="text.secondary">
                                    ({accommodation.numRooms || '12'} available Rooms)
                                </Typography>
                            </Stack>

                            <Typography variant="h4" color="primary.main" sx={{mb: 3}}>
                                ${accommodation.hostUsername}
                            </Typography>
